...
export const generateCoverLetter: GenerateCoverLetter<
    CoverLetterPayload,
    CoverLetter
> = async (
    {
...
export type UpdateJobPayload = Pick<
    Job,
...
export type UpdateCoverLetterPayload = Pick<Job, "id" | "description"> &
    Pick<CoverLetter, "content"> & { isCompleteCoverLetter: boolean };
